...
public class OriginalConversationAdapter
        extends RecyclerView.Adapter<OriginalConversationAdapter.ConversationViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ConversationViewHolder viewHolder, int position) {
        ...
        final int pad = Math.round(5 * density);
